...
function () {
  function MobileMenu() {
    ...
    this.menuContenet = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.site-header__menu-content');
    this.events();
  }
...
function () {
  function RevealOnScroll() {
    ...
    this.itemToReveal = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.feature-item, .testimonial, .headline');
    this.hideInitially();
    this.createWaypoins();
  }
